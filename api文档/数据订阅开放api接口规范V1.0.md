...
* **请求URL**
  ...
  * /services/cus_params/internal_admin_division
...
* **请求示例**
  * 示例1：http://open_api.aeotrade.com/services/cus_params/internal_admin_division?auth_key=123456789&keyword=101&page=1
* **返回参数类型**
  - JSON
